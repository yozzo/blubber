...
describe('Pagination', () => {
  describe('#getPageLink', () => {
    ...
    it('should return a query string for query object', () => {
      expect(getPageLink(1, query)).toEqual('?term=samsung&page=1')
    })
  })
  ...
  describe('#buildPagination', () => {
    ...
    it('should account for when the user is near the end of a truncated pagination', () => {
      const actual = buildPagination(query, { count: 10, limit: 3 }, 2)
      const expected = {
        totalPages: 4,
        currentPage: 1,
        prev: null,
    ...
    it('should return pagination object with a maximum of 10000 results paginated', () => {
      ...
      expect(limited1).toHaveProperty('totalPages', 1000)
      expect(limited2).toHaveProperty('totalPages', 3333)
    })
  })
})
